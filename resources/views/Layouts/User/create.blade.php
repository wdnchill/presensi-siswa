...
@section('content')
            <form action="{{ route('user.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" name="email" placeholder="MASUKAN EMAIL AKTIF" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="pw" name="password" placeholder="MASUKAN PASSWORD MINIMAL 8 CHARAKTER" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <a href="{{ route('user.index') }}" type="button" class="btn btn-danger"><i class="ti ti-arrow-narrow-left fs-7"></i> Back</a>
