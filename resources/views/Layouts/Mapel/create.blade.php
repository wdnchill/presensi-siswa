...
@section('content')
    <form action="{{ route('mapel.store') }}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="mapel" name="namaMapel" placeholder="MASUKAN MATA PELAJARAN"
                    required>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <a href="{{ route('mapel.index') }}" type="button" class="btn btn-danger show-alert-submit-box"><i
